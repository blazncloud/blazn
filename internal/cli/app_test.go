...
func TestJSONHelpIsDeterministic(t *testing.T) {
	...
	const want = "{\"command\":\"blazn\",\"usage\":\"blazn [--output human|json] <command>\",\"summary\":\"Control Blazn from the command line.\",\"commands\":[{\"name\":\"agent\",\"summary\":\"Validate, publish, and inspect versioned Agents\"},{\"name\":\"auth\",\"summary\":\"Authenticate this device and manage sessions\"},{\"name\":\"content\",\"summary\":\"Manage Content media workflows (plugin)\"},{\"name\":\"doctor\",\"summary\":\"Run offline readiness checks\"},{\"name\":\"dev\",\"summary\":\"Validate, build, test, inspect, and publish development projects\"},{\"name\":\"help\",\"summary\":\"Show help for a command\"},{\"name\":\"harness\",\"summary\":\"Validate, publish, and inspect Harness resources\"},{\"name\":\"node\",\"summary\":\"Enroll, install, recover, and heartbeat a Node\"},{\"name\":\"plugins\",\"summary\":\"Install and manage signed Blazn plugins\"},{\"name\":\"project\",\"summary\":\"Create, select, and manage Workspace Projects\"},{\"name\":\"proxy\",\"summary\":\"Activate, inspect, and recover local model routing\"},{\"name\":\"run\",\"summary\":\"Create, watch, cancel, and retrieve Project Runs\"},{\"name\":\"sandbox\",\"summary\":\"Create and operate isolated agent sandboxes\"},{\"name\":\"social\",\"summary\":\"Search public entities and manage social content (plugin)\"},{\"name\":\"template\",\"summary\":\"Validate and publish sandbox templates\"},{\"name\":\"uninstall\",\"summary\":\"Remove a receipt-owned direct installation\"},{\"name\":\"version\",\"summary\":\"Show build and contract version information\"},{\"name\":\"workspace\",\"summary\":\"Create, select, and manage workspaces\"}]}\n"
	if first != want {
