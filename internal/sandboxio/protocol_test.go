...
func TestBootstrapProtocolIsClosedBoundedAndCanonical(t *testing.T) {
	...
	invalid := [][]byte{
		...
		[]byte(`{"schemaVersion":"blazn.dev/sandbox-source-manifest/v1","sources":[{"name":"parent","url":"https://example.test/parent","destination":"/workspace/src/a","commit":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","writable":false},{"name":"sibling","url":"https://example.test/sibling","destination":"/workspace/src/a-foo","commit":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","writable":false},{"name":"child","url":"https://example.test/child","destination":"/workspace/src/a/x","commit":"cccccccccccccccccccccccccccccccccccccccc","writable":false}]}`),
	}
