...
func readSecretFile(path string) (string, error) {
	...
	if info.Mode()&os.ModeSymlink != 0 || !info.Mode().IsRegular() || info.Size() < 1 || info.Size() > maxDatabaseURLBytes || info.Mode().Perm()&0o022 != 0 {
	...
	if err != nil || !os.SameFile(info, opened) || !opened.Mode().IsRegular() || opened.Size() < 1 || opened.Size() > maxDatabaseURLBytes || opened.Mode().Perm()&0o022 != 0 {
