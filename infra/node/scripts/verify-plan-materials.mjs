...
if (binaryDigests.schemaVersion !== "blazn.dev/current-binary-digests/v1" || binaryDigests.releaseTag !== "v0.1.0-poc.104") fail("current binary release identity drifted");
