...
if (process.argv[3]) {
  ...
  const expected = { postgres: environment.ZITADEL_POSTGRES_IMAGE, proxy: environment.ZITADEL_TRAEFIK_IMAGE, "zitadel-api": environment.ZITADEL_IMAGE, "zitadel-login": environment.ZITADEL_LOGIN_IMAGE };
