...
printf '%s\n' '{"schemaVersion":"blazn.identity.active-idps/v1","authorityPrincipal":"blazn-provider-gate","authoritySentinel":"blazn-provider-gate-sentinel","organizationCount":1,"activeProviderCount":0,"observedAt":"2026-08-22T00:00:01Z"}' > "$qualification_tmp/idps-before.json"
printf '%s\n' '{"schemaVersion":"blazn.identity.active-idps/v1","authorityPrincipal":"blazn-provider-gate","authoritySentinel":"blazn-provider-gate-sentinel","organizationCount":1,"activeProviderCount":0,"observedAt":"2026-08-22T00:00:02Z"}' > "$qualification_tmp/idps-after.json"
