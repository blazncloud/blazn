...
generate-harness-worker-contract:
	go run ./cmd/generate-harness-worker-contract

check-harness-worker-generated:
	go run ./cmd/generate-harness-worker-contract --check
...
ci: fmt-check check-generated check-workspace-generated check-project-generated check-run-generated check-proxy-generated check-harness-worker-generated check-node-generated check-sandbox-generated test test-control-api test-identity test-runtime-persistence test-sandbox-contract test-project-contract test-run-contract test-development-contract test-development-sandbox-static test-harness-contract test-release test-install
